...
export const PROPERTY_EFFECTS: Record<string, readonly string[]> = {
	...
	'animation': ['animation-delay', 'animation-direction', 'animation-duration', 'animation-fill-mode', 'animation-iteration-count', 'animation-name', 'animation-play-state', 'animation-range-end', 'animation-range-start', 'animation-timeline', 'animation-timing-function', 'animation-trigger'],
	...
	'column-rule-edge-inset-end': ['column-rule-edge-inset-end'],
	'column-rule-edge-inset-start': ['column-rule-edge-inset-start'],
	'column-rule-inset': ['column-rule-edge-inset-end', 'column-rule-edge-inset-start', 'column-rule-interior-inset-end', 'column-rule-interior-inset-start'],
	...
	'column-rule-interior-inset': ['column-rule-interior-inset-end', 'column-rule-interior-inset-start'],
	'column-rule-interior-inset-end': ['column-rule-interior-inset-end'],
	'column-rule-interior-inset-start': ['column-rule-interior-inset-start'],
	...
	'row-rule-edge-inset-end': ['row-rule-edge-inset-end'],
	'row-rule-edge-inset-start': ['row-rule-edge-inset-start'],
	'row-rule-inset': ['row-rule-edge-inset-end', 'row-rule-edge-inset-start', 'row-rule-interior-inset-end', 'row-rule-interior-inset-start'],
	...
	'row-rule-interior-inset': ['row-rule-interior-inset-end', 'row-rule-interior-inset-start'],
	'row-rule-interior-inset-end': ['row-rule-interior-inset-end'],
	'row-rule-interior-inset-start': ['row-rule-interior-inset-start'],
	...
	'rule-edge-inset': ['column-rule-edge-inset-end', 'column-rule-edge-inset-start', 'row-rule-edge-inset-end', 'row-rule-edge-inset-start'],
	'rule-inset': ['column-rule-edge-inset-end', 'column-rule-edge-inset-start', 'column-rule-interior-inset-end', 'column-rule-interior-inset-start', 'row-rule-edge-inset-end', 'row-rule-edge-inset-start', 'row-rule-interior-inset-end', 'row-rule-interior-inset-start'],
	'rule-inset-end': ['column-rule-edge-inset-end', 'column-rule-interior-inset-end', 'row-rule-edge-inset-end', 'row-rule-interior-inset-end'],
	'rule-inset-start': ['column-rule-edge-inset-start', 'column-rule-interior-inset-start', 'row-rule-edge-inset-start', 'row-rule-interior-inset-start'],
	'rule-interior-inset': ['column-rule-interior-inset-end', 'column-rule-interior-inset-start', 'row-rule-interior-inset-end', 'row-rule-interior-inset-start'],
...
export const PROPERTY_EFFECT_MODES: Record<string, PropertyEffectMode> = {
	...
	'column-rule-edge-inset-end': 'self',
	'column-rule-edge-inset-start': 'self',
	...
	'column-rule-interior-inset-end': 'self',
	'column-rule-interior-inset-start': 'self',
	...
	'row-rule-edge-inset-end': 'self',
	'row-rule-edge-inset-start': 'self',
	'row-rule-inset': 'shorthand',
	'row-rule-inset-end': 'shorthand',
	'row-rule-inset-start': 'shorthand',
	'row-rule-interior-inset': 'shorthand',
	'row-rule-interior-inset-end': 'self',
	'row-rule-interior-inset-start': 'self',
	'row-rule-style': 'self',
